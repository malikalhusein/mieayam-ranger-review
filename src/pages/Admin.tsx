...
const reviewSchema = z.object({
  ...
  // Editor badges
  editor_choice: z.boolean().optional().default(false),
  take_it_or_leave_it: z.boolean().optional().default(false),
  ...
  topping_pangsit_basah: z.boolean().optional().default(false),
...
const Admin = () => {
  ...
  useEffect(() => {
    const subscription = form.watch((value) => {
      ...
      const reviewData: ReviewData = {
        ...
        topping_pangsit_basah: value.topping_pangsit_basah || false,
  ...
  const startEdit = (review: any) => {
    ...
    form.reset({
      ...
      editor_choice: review.editor_choice ?? false,
      take_it_or_leave_it: review.take_it_or_leave_it ?? false,
      ...
      topping_pangsit_basah: review.topping_pangsit_basah ?? false,
      topping_pangsit_kering: review.topping_pangsit_kering ?? false,
      topping_dimsum: review.topping_dimsum ?? false,
      topping_variasi_bumbu: review.topping_variasi_bumbu ?? false,
    });
  ...
  const handleUpdate = async (data: ReviewFormData) => {
    ...
    try {
      ...
      const reviewData = {
        ...
        editor_choice: data.editor_choice || false,
        take_it_or_leave_it: data.take_it_or_leave_it || false,
        ...
        topping_pangsit_basah: data.topping_pangsit_basah || false,
        topping_pangsit_kering: data.topping_pangsit_kering || false,
        topping_dimsum: data.topping_dimsum || false,
        topping_variasi_bumbu: data.topping_variasi_bumbu || false,
      };
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {/* Editor Badges */}
                <div className="space-y-4 p-4 border border-purple-200 bg-purple-50 dark:border-purple-800 dark:bg-purple-950 rounded-lg">
                  <div className="space-y-1">
                    <h4 className="text-sm font-semibold">Editor Badges</h4>
                    <p className="text-xs text-muted-foreground">
                      Pilih badge khusus dari editor untuk review ini.
                    </p>
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-start space-x-3 p-3 border border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950 rounded-lg">
                      <Checkbox
                        id="editor_choice"
                        checked={form.watch("editor_choice") || false}
                        onCheckedChange={(checked) => {
                          form.setValue("editor_choice", checked as boolean);
                          if (checked) form.setValue("take_it_or_leave_it", false);
                        }}
                      />
                      <div className="space-y-1">
                        <Label htmlFor="editor_choice" className="text-sm font-medium cursor-pointer flex items-center gap-2">
                          ⭐ Editor's Choice
                        </Label>
                        <p className="text-xs text-muted-foreground">
                          Rekomendasi khusus dari editor. Mie ayam yang wajib dicoba!
                        </p>
                      </div>
                    </div>
                    
                    <div className="flex items-start space-x-3 p-3 border border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950 rounded-lg">
                      <Checkbox
                        id="take_it_or_leave_it"
                        checked={form.watch("take_it_or_leave_it") || false}
                        onCheckedChange={(checked) => {
                          form.setValue("take_it_or_leave_it", checked as boolean);
                          if (checked) form.setValue("editor_choice", false);
                        }}
                      />
                      <div className="space-y-1">
                        <Label htmlFor="take_it_or_leave_it" className="text-sm font-medium cursor-pointer flex items-center gap-2">
                          ⚠️ Take It or Leave It
                        </Label>
                        <p className="text-xs text-muted-foreground">
                          Mie ayam dengan pengalaman yang sangat subjektif. Bisa jadi favorit atau kecewa.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4 p-4 border border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="topping_pangsit_basah"
                        checked={form.watch("topping_pangsit_basah") || false}
                        onCheckedChange={(checked) => form.setValue("topping_pangsit_basah", checked as boolean)}
                      />
                      <Label htmlFor="topping_pangsit_basah" className="text-sm cursor-pointer">Pangsit Basah</Label>
                    </div>
                    
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="topping_pangsit_kering"
                        checked={form.watch("topping_pangsit_kering") || false}
                        onCheckedChange={(checked) => form.setValue("topping_pangsit_kering", checked as boolean)}
                      />
                      <Label htmlFor="topping_pangsit_kering" className="text-sm cursor-pointer">Pangsit Kering</Label>
                    </div>
                    
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="topping_dimsum"
                        checked={form.watch("topping_dimsum") || false}
                        onCheckedChange={(checked) => form.setValue("topping_dimsum", checked as boolean)}
                      />
                      <Label htmlFor="topping_dimsum" className="text-sm cursor-pointer">Dimsum</Label>
                    </div>
                    
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="topping_variasi_bumbu"
                        checked={form.watch("topping_variasi_bumbu") || false}
